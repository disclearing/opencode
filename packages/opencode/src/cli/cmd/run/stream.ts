import type { Event, OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@opencode-ai/sdk/v2"
...
function flushInterrupted(data: SessionData, commits: SessionCommit[]) {
